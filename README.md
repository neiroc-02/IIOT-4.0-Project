...
We are currently updating the PCB after Version 1.0. The old version is posted but there are a few bugs that need to fixed. If anyone notices them, please post your thougts on the issues section.
